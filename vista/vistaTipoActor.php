	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2 class="miEstilo">Lista <b>Tipos de Actor</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#crudModal" class="btn btn-primary" data-toggle="modal"><i class="material-icons">&#xE84E;</i> <span>Gestión Tipos de Actor</span></a>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?php echo $arregloTipoActor[$i]->__get('id');?></td>
							<td><?php echo $arregloTipoActor[$i]->__get('nombre');?></td>
							<td>
			...
			<form action="vistaTipoActor.php" method="post">
				...
				<div class="modal-body">
						...
						<ul class="nav nav-tabs" role="tablist">
							<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#home">Datos de los Tipos de Actor</a>
							</li>
						</ul>
						<!-- Tab panes -->
