	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2 class="miEstilo">Lista <b>Unidades de Medicion</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#crudModal" class="btn btn-primary" data-toggle="modal"><i class="material-icons">&#xE84E;</i> <span>Gestión Unidades de Medicion</span></a>
		...
		<div class="modal-content">
			<form action="vistaUnidadMedicion.php" method="post">
				<div class="modal-header">						
					<h4 class="modal-title">Unidades de Medicion</h4>
				...
				<div class="modal-body">
						...
						<ul class="nav nav-tabs" role="tablist">
							<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#home">Datos Unidades de Medicion</a>
							</li>
						</ul>
						<!-- Tab panes -->
