	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2 class="miEstilo">Lista <b>Tipos de Indicadores</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#crudModal" class="btn btn-primary" data-toggle="modal"><i class="material-icons">&#xE84E;</i> <span>Gestión Tipos de Indicadores</span></a>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?php echo $arregloTipoIndicador[$i]->__get('id');?></td>
							<td><?php echo $arregloTipoIndicador[$i]->__get('nombre');?></td>
							<td>
			...
			<form action="vistaTipoIndicador.php" method="post">
				...
				<div class="modal-body">
						...
						<ul class="nav nav-tabs" role="tablist">
							<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#home">Datos de los tipos de indicadores</a>
							</li>
						</ul>
						<!-- Tab panes -->
