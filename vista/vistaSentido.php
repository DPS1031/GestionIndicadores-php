	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2 class="miEstilo">Lista <b>Sentidos</b></h2>
					</div>
					<div class="col-sm-6">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?php echo $arregloSentido[$i]->__get('id');?></td>
							<td><?php echo $arregloSentido[$i]->__get('nombre');?></td>
							<td>
			...
			<form action="vistaSentido.php" method="post">
				...
				<div class="modal-body">
						...
						<ul class="nav nav-tabs" role="tablist">
							<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#home">Datos Sobre Sentidos</a>
							</li>
						</ul>
						<!-- Tab panes -->
